...
from main.views import edit_product, delete_product, show_product
from main.views import add_product_entry_ajax, get_product_json, edit_product_ajax, delete_product_ajax, register_ajax, login_ajax
...
urlpatterns = [
    ...
    path('product/<str:id>/edit', edit_product, name='edit_product'), # check this if an error occurs
